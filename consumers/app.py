...
def process_message_payload(raw_message: Any) -> None:
    """
...
def continuous_polling_stream(consumer: Consumer) -> None:
    """
...
def main() -> None:
    ...
    continuous_polling_stream(consumer_client)
